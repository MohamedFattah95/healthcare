...
import com.gp.shifa.databinding.ActivityContactUsBinding;
...
public class ContactUsActivity extends BaseActivity<ContactUsViewModel> implements ContactUsNavigator {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mViewModel.getDataManager().isUserLogged()) {
            binding.etName.setText(mViewModel.getDataManager().getUserObject().getUser().getName());
            binding.etEmail.setText(mViewModel.getDataManager().getUserObject().getUser().getEmail());
            binding.etPhone.setText(mViewModel.getDataManager().getUserObject().getUser().getPhone());
