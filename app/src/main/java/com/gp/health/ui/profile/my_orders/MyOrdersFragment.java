...
import com.gp.health.databinding.DialogDeleteOrderBinding;
import com.gp.health.databinding.FragmentMyOrdersBinding;
...
public class MyOrdersFragment extends BaseFragment<MyOrdersViewModel> implements MyOrdersNavigator, MyOrdersAdapter.Callback {
    ...
    private void setUpOnClick() {
        ...
        binding.fabAddOrder.setOnClickListener(v -> startActivity(AddingOrderActivity.newIntent(getActivity())));
    ...
    private void subscribeViewModel() {
        ...
        mViewModel.getOrderDetailsLiveData().observe(requireActivity(), response -> {
            hideLoading();
            startActivity(AddingOrderActivity.newIntent(requireActivity())
                    .putExtra("orderDetails", response.getData()));
        });
