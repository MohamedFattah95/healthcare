...
public interface NetworkService {
    ...
    @FormUrlEncoded
    @POST("login")
    Single<DataWrapperModel<UserModel>> doLoginApiCall(@Field("mobile") String mobile,
                                                       @Field("password") String password);

    @FormUrlEncoded
    @POST("register")
    Single<DataWrapperModel<UserModel>> doRegistrationApiCall(@Field("name") String name,
                                                              @Field("mobile") String mobile,
                                                              @Field("password") String password,
                                                              @Field("user_type_id") int type);
